...
namespace CoreGameTemplate.Runtime.Handlers.Game
{
    public sealed class GameHandler : SignalListener
    {
        ...
        #region Constructor
        public GameHandler(SignalBus.Runtime.SignalBus signalBus, TutorialModel tutorialModel, LevelModel levelModel) :
            base(signalBus)
        {
