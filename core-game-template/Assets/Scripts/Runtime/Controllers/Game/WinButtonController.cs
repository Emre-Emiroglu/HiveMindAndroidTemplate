...
{
    public sealed class WinButtonController : Controller<GameModel, GameSettings, InGamePanelView>
    {
        ...
        #region Constructor
        public WinButtonController(GameModel model, InGamePanelView view, SignalBus.Runtime.SignalBus signalBus) :
