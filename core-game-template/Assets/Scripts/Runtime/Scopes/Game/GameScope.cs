...
using CoreGameTemplate.Runtime.Handlers.Game;
...
namespace CoreGameTemplate.Runtime.Scopes.Game
{
    public sealed class GameScope : LifetimeScope
    {
        ...
        #region Cycle
        private void Start() => Container.Resolve<SignalBus.Runtime.SignalBus>().Fire(new InitializeGameSignal());
        #endregion
    }
}