...
namespace CoreGameTemplate.Editor
{
    [InitializeOnLoad]
    public sealed class StartupSceneLoader
    {
        ...
        private const string LoadStartupSceneOnPlay =
            "Tools/CoreGameTemplate/StartupSceneLoader/Load Startup Scene On Play";
        private const string DontLoadStartupSceneOnPlay =
            "Tools/CoreGameTemplate/StartupSceneLoader/Don't Load Startup Scene On Play";
        #endregion
